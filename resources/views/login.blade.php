...
<body class="bg-white">
    ...
    <nav class="flex justify-between h-13 p-4 bg-green-500">
        <div class="">
            <h1 class="text-2xl font-bold text-white pl-4">Login Form</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="flex justify-center items-center p-4">
                <form method="post" action="" name="login">
                    ...
                    <button type="submit" class="w-3/5 p-2 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-teal-700">Login</button>
                    <a href="forgot-password.html" class=" text-gray-600 hover:underline hover:text-green-500">Forgot Password?</a>
